...
<body>
    ...
    <section id="main-image">
        <div class="wrapper">
            <h2>Organisez votre<br><strong> voyage sur mesure <br>et en toute sécurité</strong></h2>
    ...
    <section id="possibilities">
        <div class="wrapper">
            <article style="background-image: url(images/image-1.jpg.jpg);">
                <div class="overlay">
            ...
            <article style="background-image: url(images/as.jpg);">
                <div class="overlay">
